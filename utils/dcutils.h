...
const std::map<std::string, std::string> gvarNames 
  {
    ...
    std::pair<std::string, std::string> ("m4l"       , "m_{4 #ell}"  ),
    std::pair<std::string, std::string> ("ptZ"       , "p_{T}^{Z}"   ),
    std::pair<std::string, std::string> ("ptee"      , "p_{T}^{ee}"   ),
    std::pair<std::string, std::string> ("ptmumu"    , "p_{T}^{#mu#mu}"   ),
